...
# label_file = './dataset/CelebA/list_attr_celeba_less.txt'
# eval_file = './dataset/CelebA/list_eval_partition_less.txt'
# result = trainResNet18WithCelebA(data_folder=dataset_folder, label_file=label_file, eval_file=eval_file, output_model_path=output_path, batch_size=8, epoch=3)
label_file = './dataset/CelebA/list_attr_celeba.txt'
eval_file = './dataset/CelebA/list_eval_partition.txt'
result = trainResNet18WithCelebA(data_folder=dataset_folder, label_file=label_file, eval_file=eval_file, output_model_path=output_path)
print(result["train_accuracy"])
print(result["train_loss"])
